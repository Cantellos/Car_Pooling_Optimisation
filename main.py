...
from kmeans_ls3 import kmeans3
from kmeans_ls4 import kmeans4
...
tot_users = tot_users_g
n_drivers = n_drivers_g
map_size = map_size_g
...
# tracks1 = kmeans(users1, drivers1, polo1) # FO: 298.3
...
tracks5 = vrp1(users5, drivers5, polo5) # FO: 254.1
...
print(f"Funzione Obiettivo VRP 1", funzione_obiettivo(tracks5))

plot_all("K-Means 3",tracks3, users, drivers, polo, map_size)
plot_all("K-Means 4", tracks4, users, drivers, polo, map_size)
plot_all("VRP 1", tracks5, users, drivers, polo, map_size)
